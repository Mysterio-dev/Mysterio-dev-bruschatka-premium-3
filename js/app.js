 ...
 */
    ...
    (() => {
        ...
        function menuInit() {
            if (document.querySelector(".js-burger")) document.addEventListener("click", (function(e) {
                if (bodyLockStatus && e.target.closest(".js-burger")) {
                    bodyLockToggle();
            ...
            window.addEventListener("load", (function(e) {
                ...
                function getHeight(showMoreBlock, showMoreContent) {
                    ...
                    if ("items" === showMoreType) {
                        ...
                        const showMoreTypeValue = showMoreContent.dataset.showmoreContent ? showMoreContent.dataset.showmoreContent : 200;
        ...
        const historyDate = new core(".history-date__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
        ...
        new core(".history-block__slider", {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".about__slider-main")) new core(".about__slider-main", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector("#product-new")) new core("#product-new", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                speed: 800,
            ...
            if (document.querySelector("#product-recommend")) new core("#product-recommend", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                speed: 800,
            ...
            if (document.querySelector(".certificate__slider")) new core(".certificate__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
            ...
            if (document.querySelector(".brand__slider ")) new core(".brand__slider ", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 2,
            ...
            if (document.querySelector("._showroom-kazan ")) new core("._showroom-kazan ", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector("._showroom-ulyanovsk ")) new core("._showroom-ulyanovsk ", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector("._showroom-cheboksary ")) new core("._showroom-cheboksary ", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector("#slider-arenda")) new core("#slider-arenda", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector("#slider-kazan")) new core("#slider-kazan", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector("#slider-text")) new core("#slider-text", {
            ...
            if (document.querySelector("#slider-cheboksary")) new core("#slider-cheboksary", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector("#slider-ulyanovsk")) new core("#slider-ulyanovsk", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
        ...
        document.addEventListener("DOMContentLoaded", (() => {
            ymaps.ready((function() {
                var myMap = new ymaps.Map("map", {
                    controls: [],
                    center: [ 55.791177, 49.156558 ],
                    zoom: 13
                });
                let myPlacemark = new ymaps.Placemark([ 55.791177, 49.156558 ], {}, {
                    hasBalloon: false,
        ...
        const btnSearchClose = document.querySelector(".btn__close");
        const formSearch = document.querySelector(".header__form-search");
        if ("undefined" != typeof btnSearch && null != btnSearch) btnSearch.onclick = function() {
            formSearch.classList.add("active");
        };
        if ("undefined" != typeof btnSearch && null != btnSearch) btnSearchClose.onclick = function() {
